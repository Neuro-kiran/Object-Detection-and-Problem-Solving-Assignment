...
# Task 1: Color-Based Object Detection: Write a Python script using OpenCV to perform
...
# visualizations.
# Task 2: Object Shape Analysis: Enhance your existing code from Task 1 to include object shape
...
# Task 3: Object Angle Calculation Extend your code from Task 2 to include object angle
